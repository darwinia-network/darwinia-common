...
describe('Test filter API', function () {
    ...
    it('should return a number as hexstring eth_newPendingTransactionFilter', async function () {
        const params = []
    ...
    // it('should return the correct log, when filtering without defining an address', async function(){
    //     var params = [{
    //         "fromBlock": '0x0',
    //         "toBlock": 'latest'
    //     }]
