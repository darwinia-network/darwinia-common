...
pub type DarwiniaPrecompiles<Runtime> = (
	...
	darwinia_evm_precompile_util::Util<Runtime>, // 0x0000000000000000000000000000000000000018
	darwinia_evm_precompile_dispatch::Dispatch<Runtime>, // 0x0000000000000000000000000000000000000019
);
