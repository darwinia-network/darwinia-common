...
sp_api::decl_runtime_apis! {
	...
	pub trait EthereumRuntimeRPCApi {
		/// Returns runtime defined dvm_evm::ChainId.
		fn chain_id() -> u64;
		/// Returns dvm_evm::Accounts by address.
		fn account_basic(address: H160) -> dvm_evm::Account;
		/// Returns FixedGasPrice::min_gas_price
		fn gas_price() -> U256;
		/// For a given account address, returns dvm_evm::AccountCodes.
		fn account_code_at(address: H160) -> Vec<u8>;
		/// Returns the converted FindAuthor::find_author authority id.
		fn author() -> H160;
		/// For a given account address and index, returns dvm_evm::AccountStorages.
