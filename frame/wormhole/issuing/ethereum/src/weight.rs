...
//! Autogenerated weights for darwinia_ethereum_issuing
//!
...
/// Weight functions needed for darwinia_ethereum_issuing.
...
/// Weights for darwinia_ethereum_issuing using the Substrate node and recommended hardware.
