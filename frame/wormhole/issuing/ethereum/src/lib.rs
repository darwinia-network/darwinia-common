...
use darwinia_support::{
	balance::*, evm::DeriveSubAccount, mapping_token::*, traits::EthereumReceipt, ChainName,
};
use dp_contract::{
...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn register_response_from_contract(
			...
			let factory_id = <T as darwinia_evm::Config>::IntoAccountId::derive_account_id(factory);
