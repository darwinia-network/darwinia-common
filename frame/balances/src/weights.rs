//! Autogenerated weights for darwinia_balances
//!
...
/// Weight functions needed for darwinia_balances.
...
/// Weights for darwinia_balances using the Substrate node and recommended hardware.
