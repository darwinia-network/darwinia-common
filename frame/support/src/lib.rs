...
pub mod s2s {
	pub use crate::BridgeMessageUid;
	// --- crates.io ---
	use codec::Encode;
	...
	pub fn nonce_to_message_id(lane_id: &[u8], nonce: u64) -> BridgeMessageUid {
		let mut message_id: BridgeMessageUid = Default::default();
...
pub type BridgeMessageUid = [u8; 16];
