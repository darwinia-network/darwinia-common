...
/// Maximal weight of single Tang block.
...
/// Maximal weight of single Tang extrinsic (65% of maximum block weight = 75% for regular
...
sp_api::decl_runtime_apis! {
	...
	///
	/// This API is implemented by runtimes that are bridging with Tang chain, not the
	/// Tang runtime itself.
	pub trait TangHeaderApi {
	...
	/// Outbound message lane API for messages that are sent to Tang chain.
	///
	/// This API is implemented by runtimes that are sending messages to Tang chain, not the
	/// Tang runtime itself.
	pub trait ToTangOutboundLaneApi {
	...
	/// Inbound message lane API for messages sent by Tang chain.
	///
	/// This API is implemented by runtimes that are receiving messages from Tang chain, not the
	/// Tang runtime itself.
	pub trait FromTangInboundLaneApi {
