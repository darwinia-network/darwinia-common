...
mod tests {
	...
	fn test_basic() {
		...
		let log_entries = vec![LogEntry {
			...
			data: array_bytes::bytes_unchecked("0x00000000000000000000000074241db5f3ebaeecf9506e4ae9881860933416048eaf04151687736326c9fea17e25fc5287613693c912909cb226aa4794f26a48000000000000000000000000000000000000000000000000002386f26fc10000"),
		}];
	...
	#[test]
	fn check_receipts() {
		let expected_root = array_bytes::hex_str_array_unchecked!(
		...
		let log_entries = vec![LogEntry {
			...
			topics: vec![array_bytes::hex_str_array_unchecked!(
				"0xf36406321d51f9ba55d04e900c1d56caac28601524e09d53e9010e03f83d7d00",
				32
			)
			.into()],
			data: array_bytes::bytes_unchecked(""),
		}];
