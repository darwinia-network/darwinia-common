...
fn network_ascii_should_work() {
	for (network_id, network_id_hex) in [
		...
		(Crab::ascii_id(), "0x4372616200000000000000000000000000000000000000000000000000000000"),
		(Pangoro::ascii_id(), "0x50616e676f726f00000000000000000000000000000000000000000000000000"),
		(
			Pangolin::ascii_id(),
