...
type TangMessagesToSong = SubstrateMessageLaneToSubstrate<Tang, TangSigningParams, Song, SongSigningParams>;
...
impl SubstrateMessageLane for TangMessagesToSong {
	...
	const OUTBOUND_LANE_LATEST_RECEIVED_NONCE_METHOD: &'static str = song_node_primitives::TO_SONG_LATEST_RECEIVED_NONCE_METHOD;

	const INBOUND_LANE_LATEST_RECEIVED_NONCE_METHOD: &'static str = tang_node_primitives::FROM_TANG_LATEST_RECEIVED_NONCE_METHOD;
	const INBOUND_LANE_LATEST_CONFIRMED_NONCE_METHOD: &'static str =
		tang_node_primitives::FROM_TANG_LATEST_CONFIRMED_NONCE_METHOD;
	const INBOUND_LANE_UNREWARDED_RELAYERS_STATE: &'static str = tang_node_primitives::FROM_TANG_UNREWARDED_RELAYERS_STATE;

	const BEST_FINALIZED_SOURCE_HEADER_ID_AT_TARGET: &'static str = tang_node_primitives::FINALIZED_TANG_BLOCK_METHOD;
	const BEST_FINALIZED_TARGET_HEADER_ID_AT_SOURCE: &'static str = song_node_primitives::FINALIZED_SONG_BLOCK_METHOD;
	...
	async fn make_messages_receiving_proof_transaction(
		...
		let call = tang_runtime::MessageLaneCall::receive_messages_delivery_proof(proof).into();
		let transaction = Tang::sign_transaction(&self.source_client, &self.source_sign.signer, nonce, call);
		Ok(transaction)
	}
	...
	async fn make_messages_delivery_transaction(
		...
		let call = song_runtime::MessageLaneCall::receive_messages_proof(
	...
	messages_relay::message_lane_loop::run(
		messages_relay::message_lane_loop::Params {
			...
			delivery_params: messages_relay::message_lane_loop::MessageDeliveryParams {
				max_unrewarded_relayer_entries_at_target: song_node_primitives::MAX_UNREWARDED_RELAYER_ENTRIES_AT_INBOUND_LANE,
				max_unconfirmed_nonces_at_target: song_node_primitives::MAX_UNCONFIRMED_MESSAGES_AT_INBOUND_LANE,
				max_messages_in_single_batch: song_node_primitives::MAX_MESSAGES_IN_DELIVERY_TRANSACTION,
				...
				max_messages_size_in_single_batch: song_node_primitives::MAXIMUM_EXTRINSIC_SIZE as usize / 3,
			},
		},
