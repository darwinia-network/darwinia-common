...
export async function createAndFinalizeBlock(web3: Web3, create_empty = true) {
	const response = await customRequest(web3, "engine_createBlock", [create_empty, true, null]);
	if (!response.result) {
